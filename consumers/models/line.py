...
FAUST_TABLE = "com.udacity.cta.stations.table.transform"
ARRIVAL_TOPIC = "com.udacity.cta.producer.arrival"
KSQL_SUMMATY = "TURNSTILE_SUMMARY"
...
class Line:
    ...
    def process_message(self, message):
        ...
        elif topic_name.startswith(ARRIVAL_TOPIC): # Set the conditional to the arrival topic
            self._handle_arrival(message)

        elif topic_name == KSQL_SUMMATY: # Set the conditional to the KSQL Turnstile Summary Topic
